...
SEED = {
    "restaurants": [
        ...
        {"id": "dominos", "name": "Domino's Pizza", "category": "fast_food",
         "last_visited": None, "deals": []},
        {"id": "zalat", "name": "Zalat Pizza", "category": "fast_food",
         "last_visited": None, "deals": []},
        {"id": "mod_pizza", "name": "Mod Pizza", "category": "fast_food",
         "last_visited": None, "deals": []},
        ...
        {"id": "chipotle", "name": "Chipotle", "category": "casual",
         "last_visited": None, "deals": []},
        {"id": "mexican_cactus", "name": "Mexican Cactus", "category": "casual",
         "last_visited": None, "deals": []},
        {"id": "jasons_deli", "name": "Jason's Deli", "category": "casual",
         "last_visited": None,
         "deals": [{"day": "monday", "text": "Kids eat free"}]},
        {"id": "bread_zeppelin", "name": "Bread Zeppelin", "category": "casual",
         "last_visited": None, "deals": []},
        ...
        {"id": "panera", "name": "Panera Bread", "category": "casual",
         "last_visited": None, "deals": []},
        {"id": "hawaiian_bros", "name": "Hawaiian Bros", "category": "casual",
         "last_visited": None, "deals": []},
        {"id": "houso_bread", "name": "Houso Bread", "category": "casual",
         "last_visited": None, "deals": []},
        {"id": "lao_thai", "name": "A Bite of Lao and Thai", "category": "casual",
         "last_visited": None, "deals": []},
        {"id": "nom_noms", "name": "Nom Noms", "category": "casual",
         "last_visited": None, "deals": []},
        ...
        # --- Sit Down (Dine In) ---
        {"id": "blue_olive", "name": "Blue Olive", "category": "sit_down",
         "last_visited": None, "deals": []},
        {"id": "heritage_pizza", "name": "Heritage Pizza", "category": "sit_down",
         "last_visited": None, "deals": []},
        {"id": "ernestos", "name": "Ernesto's", "category": "sit_down",
         "last_visited": None, "deals": []},
    ]
}
